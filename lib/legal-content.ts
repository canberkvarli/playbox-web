      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "- Telefon doğrulama hizmeti: Twilio (SMS doğrulama kodları)",
            "- Bildirim altyapısı: Apple ve Google (push bildirimleri)",
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "- Phone verification service: Twilio (SMS verification codes)",
            "- Notification infrastructure: Apple and Google (push notifications)",
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "- Ödeme: iyzico",
            "- Telefon doğrulama: Twilio (giriş için SMS kodu gönderimi)",
            "- Push bildirimleri: Apple ve Google bildirim servisleri",
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "- Payments: iyzico",
            "- Phone verification: Twilio (SMS sign-in codes)",
            "- Push notifications: Apple and Google notification services",
